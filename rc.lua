...
tags = {
    names = {"Home","WEB","PAC","NEW","IRC","MUS","PIR","MOV","MIS"},
    layout = {layouts[10], layouts[8], layouts[8], layouts[10], layouts[4], layouts[5], layouts[10], layouts[1], layouts [1]}
}
for s = 1, screen.count() do
...
--Filesystems
-- /boot
boot_graph = blingbling.progress_graph({
                    height=20,
                    width=60,
                    show_text=true,
                    horizontal = true,
...
--/root
root_graph = blingbling.progress_graph({
                    height = 20,
                    width = 60,
                    horizontal = true,
                    show_text = true,
...
--/home
home_graph = blingbling.progress_graph({
                    height = 20,
                    width = 60,
                    horizontal = true,
                    show_text = true,
...
--Mem
mem_graph = blingbling.progress_graph({
                        height = 20,
                        width = 60,
                        show_text = true,
                        horizontal = true,
